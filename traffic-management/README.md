...
If you have a paid cluster, you can also access the guestbook app via the subdomain you saved in exercise: [create ingress gateway](../create-ingress-gateway/README.md).
